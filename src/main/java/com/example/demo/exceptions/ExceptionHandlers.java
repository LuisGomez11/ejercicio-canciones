...
public class ExceptionHandlers {
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ExceptionHandler(CalificacionNoValidaException.class)
	public ErrorCode calificacionNoValida(CalificacionNoValidaException e) {
		ErrorCode ec = new ErrorCode();
		ec.setCodigo(this.getId());
		ec.setMensaje(e.getMessage());
		this.LogError(ec, e);
	...
	public ErrorCode duracionNoValida(DuracionNoValidaException e) {
		ErrorCode ec = new ErrorCode();
		ec.setCodigo(this.getId());
		ec.setMensaje(e.getMessage());
		this.LogError(ec, e);
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ExceptionHandler(GeneroNoValidoException.class)
	public ErrorCode generoNoValido(GeneroNoValidoException e) {
		ErrorCode ec = new ErrorCode();
		ec.setCodigo(this.getId());
		ec.setMensaje(e.getMessage());
		this.LogError(ec, e);
